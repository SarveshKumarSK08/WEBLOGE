...
// import { submitComment } from '../lib/page';
import {submitComment} from '../src/app/api/comments'
...
const CommentsForm = ({ slug }) => {
  ...
  const handlePostSubmission = async () => {
    ...
    try {
      ...
      console.log('Error submitting comment in CommentForm:', error);
    }
  }
  ...
  //     .then((res) => {
  //       console.log("res in comment form", res);
  //       // if (res.createComment) {
  //         if (!storeData) {
  //           setFormData((prevState) => ({
  //             ...prevState,
